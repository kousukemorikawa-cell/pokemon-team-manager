 ...
 ,
  ...
  function renderDetail(){const t=current();if(!t)return;ensureTeamAdjustments(t);$('#detailTitle').textContent=t.title||'構築詳細';$('#detailContent').innerHTML=`
    <div class="section"><h3>基本情報</h3><div class="detail-grid">
      <div class="quick-input"><div class="field"><label>基本情報まとめ入力</label><input id="basicQuickInput" placeholder="日付 / 使用者 / 順位 / ポケモン1 / …（日付省略可）"></div><small>日付が先頭なら、日付・使用者・順位・パーティへ反映します。日付を省略した場合は、使用者・順位・パーティとして扱います。</small></div>
