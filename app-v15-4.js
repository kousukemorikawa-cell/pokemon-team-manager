 ...
 ,
  ...
  function renderDetail(){const t=current();if(!t)return;ensureTeamAdjustments(t);$('#detailTitle').textContent=t.title||'構築詳細';$('#detailContent').innerHTML=`
    <div class="section"><h3>基本情報</h3><div class="detail-grid">
      <div class="quick-input"><div class="field"><label>基本情報まとめ入力</label><input id="basicQuickInput" placeholder="使用者 / 順位 / ポケモン1 / ポケモン2 / …"></div><small>1つ目を使用者、2つ目を順位、3つ目以降をパーティへ反映します。日付は新規作成時に自動入力され、ここからは変更されません。</small></div>
