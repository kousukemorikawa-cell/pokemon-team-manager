const C='ptm-v57-direct-individual';
const A=['./','./index.html','./styles-v57.css','./app-v57.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
