const C='ptm-v30-restore-critical-battle-picker';
const A=['./','./index.html','./styles-v30.css','./app-v30.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
