const C='ptm-v40-action-colors-filter-dots';
const A=['./','./index.html','./styles-v40.css','./app-v40.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
