const C='ptm-v83-special-rank-selection-picker';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v83.css','./app-v83.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
