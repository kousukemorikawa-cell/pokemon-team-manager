const C='ptm-v53-team-picker-records';
const A=['./','./index.html','./styles-v53.css','./app-v53.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
