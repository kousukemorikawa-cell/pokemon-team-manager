const C='ptm-v27-history-team-picker-results';
const A=['./','./index.html','./styles-v27.css','./app-v27.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
