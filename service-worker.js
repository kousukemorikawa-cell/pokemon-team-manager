const C='ptm-v19-meta-mobile-fix';
const A=['./','./index.html','./styles-v19.css','./app-v19.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
