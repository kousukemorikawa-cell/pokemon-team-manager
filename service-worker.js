const C='ptm-v43-search-on-input-damage-box-pick';
const A=['./','./index.html','./styles-v43.css','./app-v43.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
