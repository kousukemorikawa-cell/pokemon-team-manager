const C='ptm-v76-calculator-ui';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v76.css','./app-v76.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
