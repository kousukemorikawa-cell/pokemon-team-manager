const C='ptm-v50-active-damage-autocomplete';
const A=['./','./index.html','./styles-v50.css','./app-v50.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
