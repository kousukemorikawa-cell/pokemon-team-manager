const C='ptm-v15-1';
const A=['./','./index.html','./styles-v15-1.css','./app-v15-1.js','./pokemon-data-v15-1.js','./moves-data-v15-1.js','./item-fairy-feather.png','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
