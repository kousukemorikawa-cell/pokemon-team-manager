const C='ptm-v86-selection-click-hotfix';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v86.css','./app-v86.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
