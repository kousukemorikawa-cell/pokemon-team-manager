const C='ptm-v29-split-tools-history-links';
const A=['./','./index.html','./styles-v29.css','./app-v29.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
