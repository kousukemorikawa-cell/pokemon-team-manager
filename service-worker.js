const C='ptm-v42-summed-damage-pokemon-box';
const A=['./','./index.html','./styles-v42.css','./app-v42.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
