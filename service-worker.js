const C='ptm-v80-one-screen-calculator';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v80.css','./app-v80.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
