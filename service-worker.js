const C='ptm-v85-restore-ui-hotfix';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v85.css','./app-v85.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
