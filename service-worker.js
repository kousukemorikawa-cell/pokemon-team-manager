const C='ptm-v88-battle-basic-selection-viewer';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v88.css','./app-v88.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
