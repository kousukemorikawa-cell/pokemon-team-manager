const C='ptm-v79-two-line-stepper-odds';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v79.css','./app-v79.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
