const C='ptm-v55-box-history-fixes';
const A=['./','./index.html','./styles-v55.css','./app-v55.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
