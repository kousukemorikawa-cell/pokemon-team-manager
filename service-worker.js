const C='ptm-v72-power-modifier-layer';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v72.css','./app-v72.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
