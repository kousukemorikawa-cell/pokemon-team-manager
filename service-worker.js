const C='ptm-v44-individual-set-library';
const A=['./','./index.html','./styles-v44.css','./app-v44.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
