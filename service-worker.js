const C='ptm-v52-search-moves-battle';
const A=['./','./index.html','./styles-v52.css','./app-v52.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
