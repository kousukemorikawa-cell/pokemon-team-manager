const C='ptm-v51-mobile-pokemon-battle';
const A=['./','./index.html','./styles-v51.css','./app-v51.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
