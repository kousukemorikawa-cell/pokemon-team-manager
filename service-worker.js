const C='ptm-v20-1-cloud-fix';
const A=['./','./index.html','./styles-v20.css','./app-v20.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
