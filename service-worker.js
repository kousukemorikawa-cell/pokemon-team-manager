const C='ptm-v34-bar-boundaries-defense-copy-spread';
const A=['./','./index.html','./styles-v34.css','./app-v34.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
