const C='ptm-v35-history-effort-ko-recent-teams';
const A=['./','./index.html','./styles-v35.css','./app-v35.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
