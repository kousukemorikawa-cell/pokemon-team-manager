const C='ptm-v78-selection-compact-damage';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v78.css','./app-v78.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
