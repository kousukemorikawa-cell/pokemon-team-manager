const C='ptm-v54-individual-editor';
const A=['./','./index.html','./styles-v54.css','./app-v54.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
