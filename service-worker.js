const C='ptm-v87-selection-order-and-result-hotfix';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v87.css','./app-v87.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
