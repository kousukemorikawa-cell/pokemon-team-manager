const C='ptm-v69-ko-edit-layer';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v69.css','./app-v69.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
