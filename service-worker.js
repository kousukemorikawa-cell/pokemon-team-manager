const C='ptm-v21-pokemon-notes';
const A=['./','./index.html','./styles-v21.css','./app-v21.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
