const C='ptm-v73-modifier-berry-layer';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v73.css','./app-v73.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
