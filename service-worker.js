const C='ptm-v75-battle-quick-mega-layer';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v75.css','./app-v75.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
