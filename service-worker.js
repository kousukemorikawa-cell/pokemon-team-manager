const C='ptm-v31-damage-set-picker-move-search';
const A=['./','./index.html','./styles-v31.css','./app-v31.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
