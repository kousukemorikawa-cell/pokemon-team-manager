const C='ptm-v77-selection-quick-damage';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v77.css','./app-v77.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
