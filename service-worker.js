const C='ptm-v71-multihit-modal-layer';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v71.css','./app-v71.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
