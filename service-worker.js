const C='ptm-v84-grouped-basic-selections';
const I='ptm-image-cache-v1';
const A=['./','./index.html','./styles-v84.css','./app-v84.js','./pokemon-data-v16.js','./moves-data-v16.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
