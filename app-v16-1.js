  ...
  function adjustmentHistoryEntries(pokemon,currentTeamId,currentIndex){
    ...
    state.teams.forEach(team=>{
      ...
      (team.pokemon||[]).forEach((name,index)=>{
        ...
        const signature=JSON.stringify({item:a.item||'',ability:a.ability||'',nature:a.nature||'',tera:a.tera||'',iv:a.iv||{},ev:a.ev||{},moveSlots:a.moveSlots||splitMoves(a.moves),memo:a.memo||''});
