...
function megaStoneFor(name){const n=normalizePokemonName(name);return MEGA_STONES[n]||(MEGA_NAMES.has(n)?'メガストーン':'')}
  ...
  function hideAllViews(){['listView','detailView','pokemonView','pairingView','pairingEditView','battleToolView','teamPickerView','damageHistoryView','battleHistoryView'].forEach(id=>$('#'+id)?.classList.remove('active'))}
